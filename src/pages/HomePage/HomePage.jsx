            ...
            <div className="services__grid">
              <div className="service-card">
                ...
                <p className="service-card__description">
                  Полностью организуем прощание: от сбора документов и
                  подготовки тела до поминального обеда.
                </p>
              ...
              <div className="service-card">
                ...
                <p className="service-card__description">
                  Оказываем содействие в организации воинских похорон, помогаем
                  с оформлением льгот и почестей.
                </p>
                <div className="service-card__actions">
                  <a
                    href="#"
                    aria-label="Подробнее: Захоронение участников СВО"
                  >
                    Подробнее
                  </a>
                </div>
              ...
              <div className="service-card">
                ...
                <div className="service-card__actions">
                  <a
                    href="#"
                    aria-label="Подробнее: Благоустройство захоронений"
                  >
                    Подробнее
                  </a>
                </div>
              ...
              <div className="service-card">
                ...
                <div className="service-card__actions">
                  <a
                    href="#"
                    aria-label="Подробнее: Каталог ритуальных товаров"
                  >
                    Подробнее
                  </a>
                </div>
              ...
              <div className="service-card">
                ...
                <p className="service-card__description">
                  Организуем транспортировку тела усопшего в любой город России
                  и страны СНГ.
                </p>
                <div className="service-card__actions">
          ...
          <div className="container">
            ...
            <div className="advantages__grid">
              ...
              <div className="advantage-card">
                ...
                <p className="advantage-card__description">
                  Изготавливаем памятники и ограды без посредников. Это
                  позволяет нам контролировать качество и предлагать честные
                  цены.
                </p>
              </div>
            ...
            <div className="company-stats__grid">
              <div className="company-stats__intro">
                ...
                <p className="company-stats__subtitle">
                  Помогаем жителям Шуи в трудную минуту. Работаем без перерывов
                  и выходных.
                </p>
              </div>
            ...
            <div className="card">
              <div className="card__body">
                ...
                <p className="calculator__description">
                  Чтобы вы могли спланировать бюджет, мы подготовили
                  калькулятор. Он поможет узнать ориентировочную стоимость
                  услуг.
                </p>
          ...
          <div className="container">
            ...
            <div className="transport-gallery">
              ...
              <div className="transport-item">
                ...
                <p className="transport-item__caption">
                  Комфортабельные автобусы для перевозки родных и близких к
                  месту прощания и поминального обеда.
                </p>
              </div>
                ...
                <div className="offices-list">
                  ...
                  <div className="office-item">
                    ...
                    <p className="office-item__route d-desktop-none">
                      <a
                        ...
                        href="https://yandex.ru/maps/-/CLUTYXMk"
                        target="_blank"
                  ...
                  <div className="office-item">
                    ...
                    <p className="office-item__route d-desktop-none">
                      <a
                        className="btn btn--secondary btn--sm"
                        href="https://yandex.ru/maps/-/CLUTYXkp"
                        target="_blank"
                        rel="noopener noreferrer"
                  ...
                  <div className="office-item">
                    ...
                    <p className="office-item__route d-desktop-none">
                      <a
                        className="btn btn--secondary btn--sm"
                        href="https://yandex.ru/maps/-/CLUTY2IS"
                        target="_blank"
                        rel="noopener noreferrer"
